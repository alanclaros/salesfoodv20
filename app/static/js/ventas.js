...
function confirmarAnularGeneralVenta() {
    ...
    if (motivo_an == '') {
        ...
        //function cancel
        modalFunction.value = 'ventaDialogWarning();';
        modalF.modal();
        return false;
    }
    ...
    //function cancel
    modalFunction.value = 'ventasSendAnularGeneral();';
    modalF.modal();
}

function ventasSendAnularGeneral() {
    modalF = $('#modalForm');
...
function ventasSendAnularDia() {
    ...
    datos_operation = {
        ...
        'operation_x': 'add',
        'operation_x2': 'anular_x',
        'venta_id': document.getElementById('id_null').value,
        'motivo_anula': Trim(document.getElementById('motivo_anula').value),
    }

    modalF.modal('toggle');

    ruta_imagen22 = url_empresa + '/static/img/pass/loading.gif';
    imagen22 = '<img src="' + ruta_imagen22 + '">';

    div_ventas_dia = $('#div_ventas_dia');
    div_ventas_dia.html(imagen22);
    div_ventas_dia.load('/', datos_operation, function () {
...
function confirmarAnularVenta() {
    ...
    //function cancel
    modalFunction.value = 'ventasSendAnularDia();';
    modalF.modal();
}
...
function nuevaVenta() {
    ...
    if (almacen.value == '0') {
        ...
        //set data modal
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe seleccionar un almacen', 'Cancelar', 'Volver');
    ...
    if (tipo_venta.value == '0') {
        ...
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe seleccionar un tipo de venta', 'Cancelar', 'Volver');
...
function guardarNuevoClienteVenta() {
    ...
    if (ci_nit == '') {
        ...
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe llenar el CI/NIT', 'Cancelar', 'Volver');
    ...
    if (apellidos == '') {
        ...
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe llenar los apellidos', 'Cancelar', 'Volver');
    ...
    if (nombres == '') {
        ...
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe llenar el nombre', 'Cancelar', 'Volver');
...
async function guardarVenta() {
    ...
    if (tipo_venta.value == '0') {
        //alert('Debe seleccionar un tipo de venta');
        //tipo_venta.focus();
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe seleccionar el tipo de venta', 'Cancelar', 'Volver');
        ...
        if (tipo_venta.value == 'PLANPAGO') {
            ...
            if (aux_cuotas == '') {
                ...
                modalSetParameters('warning', 'center', 'Ventas!', 'Debe indicar el numero de cuotas', 'Cancelar', 'Volver');
            ...
            if (aux_radio.checked) {
                ...
                if (aux_dias == '') {
                    ...
                    modalSetParameters('warning', 'center', 'Ventas!', 'Debe indicar los dias', 'Cancelar', 'Volver');
    ...
    if (costo_abc.value == '0') {
        //alert('Debe seleccionar un tipo de costo');
        //costo_abc.focus();
        modalSetParameters('warning', 'center', 'Ventas!', 'Debe seleccionar un tipo de costo', 'Cancelar', 'Volver');
