...
function realizarPedido() {
    ...
    if (ci_value == '') {
        ...
        //ci.focus();
        //set data modal
        modalSetParameters('warning', 'center', 'Compra!', 'Debe llenar su CI', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
    ...
    if (apellidos_value == '') {
        //alert('Debe llenar sus apellidos');
        //apellidos.focus();
        modalSetParameters('warning', 'center', 'Compra!', 'Debe llenar sus Apellidos', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
    ...
    if (nombres_value == '') {
        //alert('Debe llenar sus nombres');
        //nombres.focus();
        modalSetParameters('warning', 'center', 'Compra!', 'Debe llenar su Nombre', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
    ...
    if (telefonos_value == '') {
        //alert('Debe llenar sus telefonos');
        //telefonos.focus();
        modalSetParameters('warning', 'center', 'Compra!', 'Debe llenar su Telefono', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
    ...
    if (direccion_value == '') {
        ...
        //direccion.focus();
        modalSetParameters('warning', 'center', 'Compra!', 'Debe llenar su Direccion', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
    ...
    if (lista_ids == '') {
        ...
        modalSetParameters('warning', 'center', 'Compra!', 'Debe tener al menos un producto', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
    ...
    if (lista_productos_ids == '') {
        ...
        modalSetParameters('warning', 'center', 'Compra!', 'Debe comprar al menos un producto', 'Cancelar', 'Volver');
        //function cancel
        modalFunction.value = 'compraWarning();';
        modalF.modal();
        return false;
...
function compraEliminarProducto(p_id) {
    modalF = $('#modalForm');
    modalF.modal('toggle');
...
function eliminarProducto(p_id) {
    ...
    modalSetParameters('danger', 'center', 'Compra!', 'Esta seguro de eliminar este producto?', 'Cancelar', 'Eliminar');
    //function cancel
    modalFunction.value = "compraEliminarProducto('" + p_id + "');";
    modalF.modal();
...
function componentesProductoHP(numero_registro) {
    $('#modal-componentes-' + numero_registro).modal('show');
    loadComponentesHP(numero_registro);

    //extras
    loadExtrasHP(numero_registro);
    //refrescos
    loadRefrescosHP(numero_registro);
    //papas
    loadPapasHP(numero_registro);

    ajustarPrecioExtrasHP(numero_registro);

    totalPedidoVentaHP(numero_registro);
}

//acc, modal extras
function extrasProductoHP(numero_registro) {
...
function loadComponentesHP(numero_registro) {
...
//acc, carga de extras
function loadExtrasHP(numero_registro) {
...
function loadRefrescosHP(numero_registro) {
...
//acc, carga de papas
function loadPapasHP(numero_registro) {
...
function ajustarPrecioExtrasHP(numero_registro) {
    extras_ids = document.getElementById('extras_ids_' + numero_registro).value;
    precio_extra = 0;
    if (Trim(extras_ids) != '') {
        div_ex = Trim(extras_ids).split('|');
...
function marcarComponenteHP(check_c, componente) {
...
//acc, marcar extra
function marcarExtraHP(check_c, extra, numero_registro) {
...
//acc, marcar refresco
function marcarRefrescoHP(check_c, extra, numero_registro) {
...
//acc, marcar papa
function marcarPapaHP(check_c, extra, numero_registro) {
...
function totalPedidoVentaHP(numero_registro) {
    total_pedido = 0;
