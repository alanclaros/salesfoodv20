...
def usuarios_index(request):
    ...
    # usuarios = usuario_controller.index(request)
    # usuario_session = request.session[usuario_controller.modulo_session]
    # usuarios_perfiles = apps.get_model('permisos', 'UsersPerfiles').objects.all()
...
def usuarios_add(request):
    ...
    if existe_error:
        db_tags = get_html_column(apps.get_model('auth', 'User'), request, None, 'first_name', 'last_name', 'username', 'email')
    else:
        db_tags = get_html_column(apps.get_model('auth', 'User'), None, None, 'first_name', 'last_name', 'username', 'email')
    ...
    modulos_sistema[settings.MOD_PLAN_PAGOS] = {'modulo': 1, 'adiciona': 0, 'modifica': 1, 'elimina': 0, 'anula': 1, 'imprime': 1, 'permiso': 0}
    #modulos_sistema[settings.MOD_PEDIDOS] = {'modulo': 1, 'adiciona': 0, 'modifica': 1, 'elimina': 0, 'anula': 1, 'imprime': 1, 'permiso': 0}
    ...
    modulos_sistema[settings.MOD_PREVENTAS] = {'modulo': 1, 'adiciona': 1, 'modifica': 1, 'elimina': 0, 'anula': 1, 'imprime': 1, 'permiso': 0}
    ...
    #modulos_sistema[settings.MOD_PEDIDOS_ALMACEN] = {'modulo': 1, 'adiciona': 1, 'modifica': 0, 'elimina': 0, 'anula': 1, 'imprime': 1, 'permiso': 0}
    ...
    modulos_sistema[settings.MOD_ZONAS] = {'modulo': 1, 'adiciona': 1, 'modifica': 1, 'elimina': 1, 'anula': 0, 'imprime': 0, 'permiso': 0}
    modulos_sistema[settings.MOD_PROVEEDORES] = {'modulo': 1, 'adiciona': 1, 'modifica': 1, 'elimina': 1, 'anula': 0, 'imprime': 0, 'permiso': 0}
    ...
    modulos_sistema[settings.MOD_INSUMOS] = {'modulo': 1, 'adiciona': 1, 'modifica': 1, 'elimina': 1, 'anula': 0, 'imprime': 0, 'permiso': 0}
    modulos_sistema[settings.MOD_COMPONENTES] = {'modulo': 1, 'adiciona': 1, 'modifica': 1, 'elimina': 1, 'anula': 0, 'imprime': 0, 'permiso': 0}
...
def usuarios_modify(request, id):
    ...
    # restricciones de columna
    if existe_error:
        db_tags = get_html_column(apps.get_model('auth', 'User'), request, usuario, 'first_name', 'last_name', 'username', 'email')
    else:
        db_tags = get_html_column(apps.get_model('auth', 'User'), None, usuario, 'first_name', 'last_name', 'username', 'email')
