...
def myFirstPage(canvas, doc):
    ...
    datos_reporte['titulo'] = 'Plan de Pagos, ' + DATO_REGISTRO
...
def rptPlanPago(buffer_pdf, usuario, plan_pago_id, crear_pdf='si'):
    ...
    for detalle in plan_pago_detalles:
        ...
        datos_tabla = []
        datos_tabla = [cuota, fecha_plan, monto, saldo]
    ...
    tabla_datos = Table(data, colWidths=[20*mm, 40*mm, 30*mm, 30*mm], repeatRows=1)
    tabla_datos.setStyle(TableStyle([('BACKGROUND', (0, 0), (3, 0), colors.Color(red=(204/255), green=(204/255), blue=(204/255))),
                                     ...
                                     ('ALIGN', (1, filas+1), (3, filas+1), 'RIGHT'),
