...
def myFirstPage(canvas, doc):
    ...
    datosReporte['titulo'] = 'Salida Productos ' + DATO_CAJA
...
def rptSalidaProductos(buffer_pdf, usuario, ciudad_id, sucursal_id, almacen_id, fecha_ini, fecha_fin, anulados):
    # pdf
    ...
    datos_reporte = reporte_controller.datos_salida_productos(usuario, ciudad_id, sucursal_id, almacen_id, fecha_ini, fecha_fin, anulados)
    # print(datos_reporte)
