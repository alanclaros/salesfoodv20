...
def myFirstPage(canvas, doc):
    ...
    datosReporte['titulo'] = 'Preventas ' + DATO_CAJA
...
def rptPreventas(buffer_pdf, usuario, ciudad_id, sucursal_id, punto_id, fecha_ini, fecha_fin, anulados, inventario, venta):
    # pdf
    ...
    datos_reporte = reporte_controller.datos_preventas(usuario, ciudad_id, sucursal_id, punto_id, fecha_ini, fecha_fin, anulados, inventario=inventario, venta=venta)
    # print(datos_reporte)
    ...
    for dato in datos_reporte:
        ...
        estado = 'preventa'
        if dato['status_id'] == reporte_controller.preventa_venta:
            estado = 'venta'
