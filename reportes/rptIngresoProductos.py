...
def myFirstPage(canvas, doc):
    ...
    datosReporte['titulo'] = 'Ingreso Productos ' + DATO_CAJA
...
def rptIngresoProductos(buffer_pdf, usuario, ciudad_id, sucursal_id, almacen_id, fecha_ini, fecha_fin, anulados):
    # pdf
    ...
    datos_reporte = reporte_controller.datos_ingreso_productos(usuario, ciudad_id, sucursal_id, almacen_id, fecha_ini, fecha_fin, anulados)
    # print(datos_reporte)
